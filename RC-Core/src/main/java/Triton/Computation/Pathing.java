...
public class Pathing {
    ...
    public static ArrayList<Vec2D> computePath(Vec2D start, Vec2D dest, ArrayList<Shape2D> obstacles) {
    ...
    public static ArrayList<Vec2D> computePathVectorField(Vec2D start, Vec2D dest, ArrayList<Shape2D> obstacles) {
        Vec2D pos = new Vec2D(start);
